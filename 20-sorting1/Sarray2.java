...
-ssort hat to loop to find n minimun values from n elements and then inserts them in one step. When it find the next min, lets say, the second min, it uses an array of n - 1 elements, this makes the time n^2 max
